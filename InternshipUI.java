...
public class InternshipUI {
	...
	private String[] mainMenuOptions = { "Login,", "Prints out resume to a text file", "filter",
			"Login with a job listing" };
	...
	public InternshipUI(Internships internship, Resume resume, StudentApplication studentApplication, Student student,
			String username, String password, Employer employer, DataWriter dataWriter) {
	...
	public void run() {
		...
		while (true) {
			...
			case (3):
				...
				// TODO once we make the method for selecting and applying to a job we allow the
				// listing to be views
				break;
			}
		}
